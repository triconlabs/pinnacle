...
export default DS.RESTSerializer.extend({
    ...
    serializeBelongsTo(record, json, relationship) {
        ...
        console.log("serializing belongsTo");
        if (belongsTo) {
    ...
    serializeIntoHash(hash, type, snapshot, options) {
        ...
        console.log("HASHASHASHASHASHASHASH");
        console.log(options);
        console.log(ParseACL);
        console.log(hash);
        console.log(snapshot.typeKey);
        // Add ACL
        if (ParseACL) {
            var policy = {};
            ...
            if (ParseACL.role) {
                ...
                console.log("HASHED");
                console.log(ParseACL.role);
                if (snapshot.typeKey == 'user') {
                    console.log("hashing user");
                    policy['role:' + ParseACL.role] = {
                        read: true

                    };
                } else if (snapshot.typeKey == 'question') {
                    console.log("hashing user")
                    policy['role:' + ParseACL.role] = {
                        read: true,
                        write: true
            ...
            if (ParseACL.permissions && ParseACL.owner) {
