...
export default DS.RESTAdapter.extend({
    ...
    ajaxOptions(url, type, options) {
        ...
        if ((hash.data && type !== 'GET')) {
            ...
            console.log(this.get('sessionToken'));
    ...
    updateRecord(store, type, snapshot) {
        ...
        return this.ajax(this.buildURL(type.typeKey, id, snapshot), 'POST', {
            data: data
        });
    },
    ...
    findAll(store, type, sinceToken) {
        ...
        data.where = {};
        if (type.typeKey == 'question') {
            data.order = "number";
            data.include = "user";
        } else if (type.typeKey == 'todo') {
            data.orderByDescending = "updatedAt";
        } else if (type.typeKey == 'user') {
            // data.include = "answer";
        } else if (type.typeKey == 'answer') {
            data.include = "user";
        }
    ...
    findHasMany(store, record, relationship) {
        ...
        return this.ajax(
            this.buildURL(related.className), 'POST', {
                data: query
            });
    },
